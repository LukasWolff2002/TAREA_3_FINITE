...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{geometria.png}
    \caption{Half structure modeled in GMSH}
    \label{fig:half_structure}
\end{figure}

The results of refining the mesh globally and locally are shown in the following figures.

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width=\textwidth]{refinado1.png}
    \caption{Global mesh refinement}
    \label{fig:img1}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.35\textwidth}
    \centering
    \includegraphics[width=\textwidth]{refinado2.png}
