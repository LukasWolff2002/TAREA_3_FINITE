...
class Quad4:
    def __init__(self, 
        ...
        Args:
            ...
            node_list (list): List of three nodes defining the Quad4 element.
        ...
        self.kg, self.A, self.F_fe_global = self.get_stiffness_matrix()
    ...
    def _initialize_load_direction(self):
        """Initializes the load direction for the Quad4 element."""
    ...
    def plotGeometry(self, ax=None, text=False, nodes=True, nodeLabels=False, facecolor='lightgray', edgecolor='k', alpha=0.5):
        """
        Plots the geometry of the Quad4 element as a shaded triangle.
